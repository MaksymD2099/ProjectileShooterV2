...
public class AssetManager {
    ...
    */
    ...
    static public void preloadAllAssets()
    {
        ...
        /* ------Useless not becaue guns no longer use ImagePattern but they use Image
        ...
        gunPortalIn = new ImagePattern(new Image(fileURL("./assets/Guns/gunPortalIn.gif")));
        gunPortalOut = new ImagePattern(new Image(fileURL("./assets/Guns/gunPortalOut.gif")));
    ...
    //Getters for all gun assets ------Useless because guns no longer use ImagePattern but they use Image
    /*
